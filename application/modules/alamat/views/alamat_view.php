   ...
   <script type="text/javascript">
	 ...
	 function Ubah_Data(id){
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>alamat/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('alamat/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
        ...
        var desc = $("#desc").val(); 
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>alamat/simpan_data",
             type:"POST",
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>alamat/fetch_alamat" 
		});
