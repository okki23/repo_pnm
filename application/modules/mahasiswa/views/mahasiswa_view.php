                        ...
                        <div class="modal-body">
                              <form method="post" id="user_form" enctype="multipart/form-data">   
                                    ...
                                    <div class="form-group">
										...
										<input type="text" name="nim" id="nim" tabindex="1" class="form-control" placeholder="NIM" value="">
									</div>
                                    <div class="form-group">
   ...
   <script type="text/javascript">
     ...
     function Ubah_Data(id){
        ...
        $('#user_form')[0].reset();
        $.ajax({
             url:"<?php echo base_url(); ?>mahasiswa/get_data_edit/"+id,
             type:"GET",
             dataType:"JSON", 
     ...
     function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('mahasiswa/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
            ...
            error: function (jqXHR, textmahasiswa, errorThrown)
            {
    ...
    function Simpan_Data(){ 
        var formData = new FormData($('#user_form')[0]);  
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>mahasiswa/simpan_data",
             type:"POST",
             data:formData,
             contentType:false,  
             processData:false,   
     ...
     $('#example').DataTable( {
            "ajax": "<?php echo base_url(); ?>mahasiswa/fetch_mahasiswa" 
